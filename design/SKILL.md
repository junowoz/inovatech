...
- [typography.md](references/typography.md) — Text wrapping, font smoothing, tabular numbers
- [surfaces.md](references/surfaces.md) — Border radius, optical alignment, shadows, image outlines
- [animations.md](references/animations.md) — Interruptible animations, enter/exit transitions, icon animations, scale on press
- [performance.md](references/performance.md) — Transition specificity, `will-change` usage
